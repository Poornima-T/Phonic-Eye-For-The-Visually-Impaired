...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sayHello("Welcome, I'm Phonic. Your Visual Assistant. I will identify the objects around you. Press and hold the screen and say open the camera after you hear a pop sound.");
        ...
        mSpeechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onResults(Bundle bundle) {
                ...
                Intent startCameraIntent = new Intent(MainActivity.this, ListenActivity.class);
